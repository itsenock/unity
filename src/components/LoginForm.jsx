...
const LoginForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (isRegistering) {
                ...
                response = await fetch('https://unity-hdfs.onrender.com/signup', {
                    method: 'POST',
                    headers: {
                ...
                response = await fetch('https://unity-hdfs.onrender.com/login', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    const handlePasswordReset = async () => {
        try {
            const response = await fetch('https://unity-hdfs.onrender.com/forgot-password', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
